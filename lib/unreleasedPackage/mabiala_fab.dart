...
class AdvFab extends StatefulWidget {
  ...
  /// Use it for Debuging,
  /// warning and errors will always be printed
  final bool showLogs;
  const AdvFab({
    Key key,
...
///as a navigation bar
class MabialaBottomBarBody extends StatefulWidget {
  ...
  @override
  _MabialaBottomBarBodyState createState() => _MabialaBottomBarBodyState();
}

class _MabialaBottomBarBodyState extends State<MabialaBottomBarBody> {
  @override
  void initState() {
    super.initState();
